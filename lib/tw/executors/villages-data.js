...
const executors = ({ senders, emitterKey }) =>
  ({
    ...
    [AUTHENTICATION_CHARACTER_SELECTED_TYPE_RECEIVE]: ({ response }) => {
      ...
      senders.close('Character not found', { emitterKey, isError: true })
    },
