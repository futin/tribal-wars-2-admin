...
const executors = ({ senders }) => {
  ...
  return ({
    ...
    [CHARACTER_INFO_TYPE_RECEIVE]: ({ response, config }) => {
      ...
      const { playerVillageNamesToIgnore = [], playerVillagesToAllow = [], shufflePlayerVillages } = config
