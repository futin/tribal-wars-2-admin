...
import {
  ...
  ATTACK_SCHEDULER_MODE, RECRUIT_UNITS_MODE, RECRUIT_SPIES_MODE, VILLAGES_DATA_MODE, RELOCATE_UNITS_MODE, MOVE_SPECIFIC_UNITS_MODE,
  MASS_DONATION_MODE
...
const tribalWarsExecutors = async ({ config, mode, emitterKey }) => {
  ...
  if (mode === RELOCATE_UNITS_MODE) {
    ...
    executors = relocateUnitsExecutors({ senders })
  }
