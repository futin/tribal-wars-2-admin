...
// local modules
import {
  AUTH_LOGIN_TYPE_SEND, AUTH_SELECT_CHARACTER_TYPE_SEND, MAP_VILLAGES_BY_AREA_TYPE_SEND, MAP_VILLAGES_DETAILS_TYPE_SEND,
  CHARACTER_INFO_TYPE_SEND, ARMY_PRESETS_GET_FOR_VILLAGE_TYPE_SEND, COMMAND_SEND_PRESET_TYPE_SEND,
  ICON_GET_ATTACKING_VILLAGES_TYPE_SEND, BARRACKS_RECRUIT_TYPE_SEND, HOO_RECRUIT_TYPE_SEND, VILLAGES_DATA_TYPE_SEND
} from '../constants'
...
const senders = ws => {
  ...
  const debouncedSendInfo = _.debounce(sendGetCharacterInfo, 10 * 1000)
