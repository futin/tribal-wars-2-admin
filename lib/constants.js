...
export const VALID_TW_MODES = [FARMING_MODE, BUILDING_UPGRADES_MODE, RECRUIT_UNITS_MODE, RECRUIT_SPIES_MODE, VILLAGES_DATA_MODE, ATTACK_SCHEDULER_CALCULATION_MODE, ATTACK_SCHEDULER_MODE, MOVE_UNITS_MODE, MASS_DONATION_MODE]
