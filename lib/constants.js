...
// MODES
export const ATTACK_MODE = 'attack'
export const BUILDING_UPGRADES_MODE = 'build'
...
export const MOVE_UNITS_MODE = 'move_units'
export const MASS_DONATION_MODE = 'mass_donation'
export const VALID_TW_MODES = [ATTACK_MODE, BUILDING_UPGRADES_MODE, RECRUIT_UNITS_MODE, RECRUIT_SPIES_MODE, VILLAGES_DATA_MODE, ATTACK_SCHEDULER_CALCULATION_MODE, ATTACK_SCHEDULER_MODE, MOVE_UNITS_MODE, MASS_DONATION_MODE]
