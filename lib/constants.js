...
const VILLAGES_DATA_MODE = 'getVillagesData'
const VALID_TW_MODES = [ATTACK_MODE, RECRUIT_UNITS_MODE, RECRUIT_SPIES_MODE, VILLAGES_DATA_MODE, ATTACK_SCHEDULER_CALCULATION_MODE, ATTACK_SCHEDULER_MODE]
