...
export const TRADING_RESOURCES_MODE = 'mass_donation'
export const RESOURCE_DEPOSIT_MODE = 'resource_deposit'
export const VALID_TW_MODES = [FARMING_MODE, BUILDING_UPGRADES_MODE, RECRUIT_UNITS_MODE, RECRUIT_SPIES_MODE, VILLAGES_DATA_MODE, ATTACK_SCHEDULER_CALCULATION_MODE, ATTACK_SCHEDULER_MODE, MOVE_SPECIFIC_UNITS_MODE, RELOCATE_UNITS_MODE, MASS_DONATION_MODE, TRADING_RESOURCES_MODE, RESOURCE_DEPOSIT_MODE]
...
export const TRADING_RESOURCES_SEND = 'Trading/sendResources'
export const TRADING_MERCHANT_STATUS_SEND = 'Trading/getMerchantStatus'
export const RESOURCE_DEPOSIT_OPEN_SEND = 'ResourceDeposit/open'
export const RESOURCE_DEPOSIT_COLLECT_SEND = 'ResourceDeposit/collect'
export const RESOURCE_DEPOSIT_START_JOB_SEND = 'ResourceDeposit/startJob'
...
export const TRADING_MERCHANT_STATUS_RECEIVE = 'Trading/merchantStatus'
export const RESOURCE_DEPOSIT_INFO_RECEIVE = 'ResourceDeposit/info'
export const RESOURCE_DEPOSIT_COLLECTED_RECEIVE = 'ResourceDeposit/collected'
export const RESOURCE_DEPOSIT_STARTED_JOB_RECEIVE = 'ResourceDeposit/jobStarted'
