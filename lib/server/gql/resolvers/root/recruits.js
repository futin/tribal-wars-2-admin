...
export default {
  ...
  Mutation: {
    ...
    activateImmediateSpyRecruit: (__, { villagesToIgnore, maxRecruitSpies }, { models, methods, auth }) =>
      methods.activateImmediateSpyRecruit({ models, config: { auth, maxRecruitSpies, villagesToIgnore } }),
