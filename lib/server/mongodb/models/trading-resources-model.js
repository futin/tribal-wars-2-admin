...
const configSchema = Schema({
  ...
  sourceVillageAvailableResourcesRichThresholdInPercent: Number,
  sourceVillageAvailableResourcesThresholdInPercent: Number,
  targetVillageAvailableResourcesPoorThresholdInPercent: Number,
  ...
  minSourceVillageResourcesThresholdInPercent: Number,
  maxTargetVillageResourcesThresholdInPercent: Number
}, { _id: false })
